...
#resources_file='../YYYY_CONT_CAUSE.xlsx'
#resources_file='../YYYY_RESOURCES.xlsx'
resources_file='../YYYY+_PROCESSED_RESOURCES.xlsx'
...
for jj in range(len(years)):
    ...
    for ii in range(len(irwinIDs)):
        ...
        resources.to_csv('./fire_features_resources_split/'+fireID+str(years[jj])+'_Daily_RESOURCES_'+str(start_time)+'Z_day_start.csv') #daily averages
